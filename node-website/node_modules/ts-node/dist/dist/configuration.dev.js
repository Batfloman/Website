...
function readConfig(cwd, ts, rawApiOptions) {
  ...
  if (!skipProject) {
    configFilePath = project ? (0, path_1.resolve)(cwd, project) : ts.findConfigFile(projectSearchDir, fileExists);
  ...
  var files = (_c = (_b = rawApiOptions.files) !== null && _b !== void 0 ? _b : tsNodeOptionsFromTsconfig.files) !== null && _c !== void 0 ? _c : index_1.DEFAULTS.files;
...
function filterRecognizedTsConfigTsNodeOptions(jsonObject) {
  ...
  var compiler = jsonObject.compiler,
      ...
      swc = jsonObject.swc,
      experimentalResolverFeatures = jsonObject.experimentalResolverFeatures,
      esm = jsonObject.esm,
      unrecognized = _objectWithoutProperties(jsonObject, ["compiler", "compilerHost", "compilerOptions", "emit", "files", "ignore", "ignoreDiagnostics", "logError", "preferTsExts", "pretty", "require", "skipIgnore", "transpileOnly", "typeCheck", "transpiler", "scope", "scopeDir", "moduleTypes", "experimentalReplAwait", "swc", "experimentalResolverFeatures", "esm"]);
  ...
  var filteredTsConfigOptions = {
    ...
    swc: swc,
    experimentalResolverFeatures: experimentalResolverFeatures,
    esm: esm
