...
var node_cjs_helpers_1 = require("../dist-raw/node-cjs-helpers");
...
function phase2(payload) {
  var _payload$parseArgvRes = payload.parseArgvResult,
      ...
      code = _payload$parseArgvRes.code,
      interactive = _payload$parseArgvRes.interactive,
      cwdArg = _payload$parseArgvRes.cwdArg,
      restArgs = _payload$parseArgvRes.restArgs,
  ...
  var cwd = cwdArg || process.cwd();
  /** Unresolved.  May point to a symlink, not realpath.  May be missing file extension */

  var scriptPath = executeEntrypoint ? (0, path_1.resolve)(cwd, restArgs[0]) : undefined;
...
function phase3(payload) {
  ...
  var _payload$phase2Result = payload.phase2Result,
      cwd = _payload$phase2Result.cwd,
      scriptPath = _payload$phase2Result.scriptPath;
...
function phase4(payload) {
  ...
  var _payload$phase2Result2 = payload.phase2Result,
      executeEval = _payload$phase2Result2.executeEval,
      cwd = _payload$phase2Result2.cwd,
      executeStdin = _payload$phase2Result2.executeStdin,
      executeRepl = _payload$phase2Result2.executeRepl,
      executeEntrypoint = _payload$phase2Result2.executeEntrypoint,
      scriptPath = _payload$phase2Result2.scriptPath;
  ...
  (_process$execArgv = process.execArgv).push.apply(_process$execArgv, [entrypoint].concat(_toConsumableArray(argv.slice(2, argv.length - restArgs.length)))); // TODO this comes from BoostrapState


  process.argv = [process.argv[1]].concat(executeEntrypoint ? [scriptPath] : []).concat(restArgs.slice(executeEntrypoint ? 1 : 0)); // Execute the main contents (either eval, script or piped).
...
function requireResolveNonCached(absoluteModuleSpecifier) {
  ...
  var isSupportedNodeVersion = (0, index_1.versionGteLt)(process.versions.node, '12.2.0');
