...
function () {
  ...
  _createClass(SourceMapConsumer, [{
    ...
    value: function _with(rawSourceMap, sourceMapUrl, f) {
      var consumer;
      return regeneratorRuntime.async(function _with$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 5;
              return regeneratorRuntime.awrap(f(consumer));
...
function (_SourceMapConsumer) {
  ...
  function BasicSourceMapConsumer(aSourceMap, aSourceMapURL) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(BasicSourceMapConsumer).call(this, INTERNAL));
    ...
    _this._names = ArraySet.fromArray(names.map(String), true);
    _this._sources = ArraySet.fromArray(sources, true);
    _this._absoluteSources = _this._sources.toArray().map(function (s) {
      return util.computeSourceURL(sourceRoot, s, aSourceMapURL);
    });
    _this.sourceRoot = sourceRoot;
    _this.sourcesContent = sourcesContent;
    _this._mappings = mappings;
    _this._sourceMapURL = aSourceMapURL;
    _this.file = file;
    _this._computedColumnSpans = false;
    _this._mappingsPtr = 0;
    _this._wasm = null;
    var w = wasm.sync();
    _this._wasm = w;
    return _this;
...
function (_SourceMapConsumer2) {
  ...
  function IndexedSourceMapConsumer(aSourceMap, aSourceMapURL) {
    ...
    _this6 = _possibleConstructorReturn(this, _getPrototypeOf(IndexedSourceMapConsumer).call(this, INTERNAL));
    var sourceMap = aSourceMap;
    ...
    if (version != _this6._version) {
      throw new Error("Unsupported version: " + version);
    }

    _this6._sources = new ArraySet();
    _this6._names = new ArraySet();
    _this6.__generatedMappings = null;
    _this6.__originalMappings = null;
    _this6.__generatedMappingsUnsorted = null;
    _this6.__originalMappingsUnsorted = null;
    var lastOffset = {
      line: -1,
      column: 0
    };
    _this6._sections = sections.map(function (s) {
      if (s.url) {
