...
function generateAstTypes() {
  ...
  code += "}\n\n";
  code += "export type DeprecatedAliases = ".concat(Object.keys(_index["default"].DEPRECATED_KEYS).join(" | "), "\n\n");
  return code;
}
