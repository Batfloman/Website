...
function generateLowercaseBuilders() {
  ...
  Object.keys(_index2["default"].BUILDER_KEYS).forEach(function (type) {
    ...
    output += "".concat(formatedBuilderNameLocal === formatedBuilderName ? "export " : "", "function ").concat(formatedBuilderNameLocal, "(").concat(defArgs.join(", "), "): t.").concat(type, " { return builder.apply(\"").concat(type, "\", arguments); }\n");
