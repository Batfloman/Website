...
function create(createOptions) {
  var swc = createOptions.swc,
      ...
      transpilerConfigLocalResolveHelper = createOptions.transpilerConfigLocalResolveHelper; // Load swc compiler
  ...
  var nonTsxOptions = createSwcOptions(false);
  var tsxOptions = createSwcOptions(true);
  ...
  function createSwcOptions(isTsx) {
    ...
    3; // swc only supports these 4x module options [MUST_UPDATE_FOR_NEW_MODULEKIND]

    var moduleType = module === ModuleKind.CommonJS ? 'commonjs' : module === ModuleKind.AMD ? 'amd' : module === ModuleKind.UMD ? 'umd' : 'es6'; // In swc:
...
var swcTargets = ['es3', 'es5', 'es2015', 'es2016', 'es2017', 'es2018', 'es2019', 'es2020', 'es2021', 'es2022'];
var ModuleKind = {
  None: 0,
  CommonJS: 1,
  AMD: 2,
