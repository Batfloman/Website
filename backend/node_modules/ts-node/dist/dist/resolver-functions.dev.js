...
function createResolverFunctions(kwargs) {
  ...
  var resolveModuleNames = function resolveModuleNames(moduleNames, containingFile, reusedNames, redirectedReference, optionsOnlyWithNewerTsVersions) {
    return moduleNames.map(function (moduleName) {
      var _ts$resolveModuleName = ts.resolveModuleName(moduleName, containingFile, config.options, host, moduleResolutionCache, redirectedReference),
  ...
  var getResolvedModuleWithFailedLookupLocationsFromCache = function getResolvedModuleWithFailedLookupLocationsFromCache(moduleName, containingFile) {
    var ret = ts.resolveModuleNameFromCache(moduleName, containingFile, moduleResolutionCache);
