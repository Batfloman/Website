...
function getProcessTopLevelAwait() {
  if (_processTopLevelAwait === undefined) {
    var _require = require('../dist-raw/node-repl-await');
...
var RECOVERY_CODES = new Set([1003, 1005, 1109, 1126, 1160, 1161, 2355 // "A function whose declared type is neither 'void' nor 'any' must return a value."
]);
/**
...
function isRecoverable(error) {
  return error.diagnosticCodes.every(function (code) {
    return RECOVERY_CODES.has(code);
  });
}
/**
 * @internal
