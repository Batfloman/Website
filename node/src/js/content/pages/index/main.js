...
const axis = new THREE.Vector3(1.5, 1.5, 1.5).normalize();
{
    ...
    const sun = new THREE.Mesh(new THREE.SphereGeometry(1, 100, 100), 
...
}
{
    ...
    const planet = new THREE.Mesh(new THREE.SphereGeometry(0.5, 100, 100), new THREE.MeshBasicMaterial({ color: 0xffffff * Math.random() }));
    group.add(planet);
...
// ====
{
    ...
    const line = new THREE.Line(new THREE.BufferGeometry().setFromPoints(points), new THREE.MeshBasicMaterial({ color: 0xffffff }));
