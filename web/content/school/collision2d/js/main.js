...
window.onload = () => {
    ...
    form2.selected = true;
    s.addObject(form2);
    let form3 = new FormObject(new Vector2(), new Polygon2([
        new Vector2(0, 100),
        new Vector2(50, 10),
        new Vector2(-10, -60),
        new Vector2(-200, -10),
    ...
    s.addObject(form3);
    let form4 = new FormObject(new Vector2(100, 100), new Polygon2([
        new Vector2(0, 100),
        new Vector2(50, 10),
        new Vector2(-10, -60),
        new Vector2(-200, -10),
...
function createRandomShape() {
    return new FormObject(new Vector2(Util.randomBetween(-50, 50, 2), Util.randomBetween(-50, 50, 2)), new Form(Util.randomBetween(5, 5), Util.randomBetween(25, 75, 2), Util.randomBetween(0.5, 1, 2)));
}
