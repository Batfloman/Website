...
function createRandomShape() {
    return new FormObject(new Vector2(Util.randomBetween(-0, 0, 2), Util.randomBetween(-0, 0, 2)), new Form(Util.randomBetween(5, 5), Util.randomBetween(25, 75, 2), Util.randomBetween(0.5, 1, 2)));
}
